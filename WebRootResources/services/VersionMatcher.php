...
// Currently served via: https://github.com/TYPO3GmbH/site-intercept/blob/develop/legacy_hook/ajaxversions.php
...
class VersionMatcher
{
    ...
    protected $legalNamesOfVersionFolders = array('latest', 'master'); //, 'stable');
