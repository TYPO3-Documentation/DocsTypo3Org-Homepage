...
.. toctree::
   ...
   Getting Started Tutorial ➜              <https://stage.docs.typo3.com/typo3cms/GettingStartedTutorial/>
   Installation & Upgrade Guide ➜        <https://stage.docs.typo3.com/typo3cms/InstallationGuide/>
   Frontend Localization ➜                 <https://stage.docs.typo3.com/typo3cms/FrontendLocalizationGuide/>
   Tutorial for Editors ➜                  <https://stage.docs.typo3.com/typo3cms/EditorsTutorial/>
   TypoScript in 45 Minutes ➜              <https://stage.docs.typo3.com/typo3cms/TyposcriptIn45MinutesTutorial/>
   Sitepackage Tutorial ➜                  <https://stage.docs.typo3.com/typo3cms/SitePackageTutorial/>
   Templating Tutorial ➜                    <https://stage.docs.typo3.com/typo3cms/TemplatingTutorial/>
   Developing TYPO3 Extensions with Extbase and Fluid (book)  ➜ <https://stage.docs.typo3.com/typo3cms/ExtbaseFluidBook/Index.html>
   Extbase & Fluid Guide ➜                       <https://stage.docs.typo3.com/typo3cms/ExtbaseGuide/>
   Core Contribution Guide ➜               <https://stage.docs.typo3.com/typo3cms/ContributionWorkflowGuide/>
...
.. t3-field-list-table::
 ...
 - :Title:        `Getting Started Tutorial <https://stage.docs.typo3.com/typo3cms/GettingStartedTutorial/>`__
...
.. t3-field-list-table::
 ...
 - :Title:        `Tutorial for Editors <https://stage.docs.typo3.com/typo3cms/EditorsTutorial/>`__
   :Category:     Editing
...
.. t3-field-list-table::
 ...
 - :Title:        `Sitepackage Tutorial <https://stage.docs.typo3.com/typo3cms/SitePackageTutorial/>`__
   :Category:     Development / Integration
 ...
 - :Title:        :ref:`Templating Tutorial <t3templating:start>`
   ...
   :Description:  The tutorial now teaches templating with FLUIDTEMPLATE (recommended)
                  in its `master branch <https://stage.docs.typo3.com/typo3cms/TemplatingTutorial/>`__.
                  *Marker based templating* used to be prevalent before. It can
                  be found in the `7.6 branch
                  <https://stage.docs.typo3.com/typo3cms/TemplatingTutorial/7.6/>`__.
                  The `Sitepackage Tutorial
                  <https://stage.docs.typo3.com/typo3cms/SitePackageTutorial/>`__
...
.. t3-field-list-table::
 ...
 - :Title:        `TYPO3 Surf <https://stage.docs.typo3.com/surf/>`__
   :Category:     Deployment
